...
public class ActivityUtils {
    ...
    public void closeSelf(Activity ac) {

                ac.overridePendingTransition(R.anim.zoomout, R.anim.zoomin);
                ac.finish();
    ...
    public void showActivity(Activity aty, Bundle bundle, Class clazz) {
        Intent i = new Intent(aty, clazz);
        i.putExtras(bundle);
        aty.startActivity(i);
        aty.overridePendingTransition(R.anim.zoomin, R.anim.zoomout);
