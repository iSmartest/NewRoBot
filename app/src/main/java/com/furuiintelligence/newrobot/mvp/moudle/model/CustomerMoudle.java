...
// ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
//          佛祖保佑     永不宕机      永无BUG
//        Name 赋睿智能-Date 2018/5/9-Time 11:45
//                   站在顶峰,看世界
//                   跌落谷底,思人生
...
public interface CustomerMoudle extends BaseModel {
    void getCustomerMoudle(MyNetWorkCallback<InfromationEntity> callback, Map<String, String> map);
