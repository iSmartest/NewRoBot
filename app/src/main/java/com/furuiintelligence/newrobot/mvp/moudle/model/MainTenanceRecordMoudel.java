...
// ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
//          佛祖保佑     永不宕机      永无BUG
//        Name 赋睿智能-Date 2018/5/29-Time 9:04
//                   站在顶峰,看世界
//                   跌落谷底,思人生
...
public interface MainTenanceRecordMoudel extends BaseModel {
    void getMainTenanMoudel(MyNetWorkCallback<MpbListEntity> callback, Map<String, String> mainMap);
